...
func (s *SettingService) GetAPITokenOnly() (bool, error) {
	return s.getBool("apiTokenOnly")
}

func (s *SettingService) SetAPITokenOnly(enabled bool) error {
	return s.setBool("apiTokenOnly", enabled)
}

func (s *SettingService) GetAPIDefaultRateLimit() (int, error) {
	return s.getInt("apiDefaultRateLimit")
}

func (s *SettingService) SetAPIDefaultRateLimit(limit int) error {
	if limit < 0 {
		limit = 0
	}
	return s.setInt("apiDefaultRateLimit", limit)
}
